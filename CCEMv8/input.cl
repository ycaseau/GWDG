...
// key design : inventory at current price in 2010 = 70% of reserve
...
Oil :: FiniteSupplier( index = 1,
   ...
   production = Oil2010,
   price = 35.3,                   // 60$ a baril -> 410$ a ton -> 35.34 a MWh 
...
Coal :: FiniteSupplier( index = 2,
   ...
   capacityFactor = 110%,            // steers the capacity growth
   capacityGrowth = 1%,              // growth at +3% in the 2005-2010, quite flat then
...
USeco :: Block(
   ...
   investE = EUgdp * 0.3%,           // amount of energy in green energies + Nuke in 2010 ...
...
EUeco :: Block(
   ...
   investE = EUGdp * 1%,     // amount of energy in green energies + Nuke in 2010 ...
...
CNeco :: Block(
   ...
   investE = CNgdp * 1%,    // amount of energy in green energies + Nuke in 2010 ...
                            // approx 500 B CNY (1% of GDP 2010) = 0.07 T$
...
INeco :: Block(
   ...
   investE = INgdp * 1%,           // amount of energy in green energies + Nuke in 2010 ...
...
RWeco :: Block(
   ...
   investG = (Wgdp * Wir),  // T$
   investE = Wgdp * 1%,           // amount of energy in green energies + Nuke in 2010 ...

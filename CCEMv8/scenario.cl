...
// h2-: (2100) PNB: 67.5T$, 60.0PWh -> 552.0ppm CO2, 16.5C, 14.8PWh clean, 39.8% electricity
// peak Oil in 2020
h2- :: Experiment(
   comment = "h2-: conservative estimate of Oil inventory - what we believed in 2009",
   init = (n){ 
      Oil.inventory := affine(list(30.0, 2200.0),list(60.0,2600.0), list(120.0,3300.0)),     // 2009 reserves
      Gas.inventory := affine(list(7.0, 1800.0),list(15.0,2400.0), list(30.0,2900.0)),     // 
      Coal.inventory := affine(list(7.0, 7000.0),list(15.0,12000.0), list(30.0,15000.0))})  // 

// h2+ is CCEM v7
// h2+: (2100) PNB: 125.5T$, 130.1PWh -> 598.2ppm CO2, 16.7C, 23.9PWh clean, 33.1% electricity
// peak Oil in 2035 vs 2042 with CCEM v8 data
h2+ :: Experiment(
...
// h2++:(2100) PNB: 141.8T$, 152.9PWh -> 605.4ppm CO2, 16.8C, 25.7PWh clean, 31.5% electricity
h2++ :: Experiment(
   ...
   init = (n){ 
        ...
        Gas.inventory := affine(list(7.0, 2000.0),list(15.0,5000.0), list(30.0,10000.0)),    
        Coal.inventory := affine(list(7.0, 8000.0),list(15.0,15000.0), list(30.0,30000.0)) })
...
// h9+: (2100) PNB: 129.0T$, 140.6PWh -> 597.1ppm CO2, 16.7C, 23.4PWh clean, 31.9% electricity
...
// h9++:(2100) PNB: 123.3T$, 136.3PWh -> 595.8ppm CO2, 16.7C, 22.9PWh clean, 31.6% electricity
h9++ :: Experiment(
   comment = "h9++: Global warming damages with high values for impact",
   init = (n){ 

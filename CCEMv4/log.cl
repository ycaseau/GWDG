...
// January 31th : compile gw4 before closing it



// ================================= Possible ideas for GW5 =========================================


Urgent improvements
===================
(1) move to TWh for energy
(2) techFactor is different for world (consumption) and Energy (one per source)
(3) introduce the production of electricity as a KPI
    and think how electricity sources changes should be handled since
    the Carnot factor is in our favor (1/3)
...
// Key new components for GW5

- stratégie player = goals (économie, pain, CO2)  
...
- IDEA for GW6 : introduce strategies for supplier (requires keeping economic record ... the goal is to maximize LT profits)
